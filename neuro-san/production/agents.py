...
def copy_specialist(vacancy: dict) -> dict:
    ...
    try:
        ...
        sys = (f"Je bent de senior recruitment-copywriter van Maintec (15+ jaar technische "
               ...
               "1) SALARIS ALTIJD IN DE TEKST: het salaris staat ALTIJD in de vacaturetekst — als EERSTE "
               "bullet van 'wat_kun_je_van_ons_verwachten', met de concrete bedragen uit de feiten "
               "(bijv. '€ 3.000 tot € 4.000 bruto per maand'); zijn er geen bedragen maar wél een CAO, "
               "noem dan die CAO. Laat het salaris NOOIT weg.\n"
               "2) NOOIT OVERNAME / 1040 UUR: neem NOOIT een overname-clausule of de '1040 uur'-regeling op "
               "(overname/indiensttreding bij de opdrachtgever na een aantal gewerkte uren). Dat is interne "
               "uitzend-/contractinformatie en hoort NOOIT in een vacaturetekst. Noem dus nergens '1040 uur' "
               "of een overnametermijn.\n"
